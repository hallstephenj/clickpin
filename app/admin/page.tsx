          ...
          <>
            ...
            {flagsLoading && featureFlags.length === 0 ? (
              ...
              <div className="space-y-2">
                ...
                {featureFlags
                  .filter((flag) => flag.key === 'fancy_board_enabled' || flag.key === 'GHOSTS' || flag.key === 'BADGES' || flag.key === 'SHARENOTES' || flag.key === 'ROTATONATOR')
                  .map((flag) => (
                    <div
                      key={flag.id}
                ...
                {featureFlags.some((f) => f.key !== 'fancy_board_enabled' && f.key !== 'GHOSTS' && f.key !== 'BADGES' && f.key !== 'SHARENOTES' && f.key !== 'ROTATONATOR' && f.enabled) &&
